export const stuffAboutMe = [
  ...
  {
    id: 6,
    title: "Indutrial Manufacturing Engineer",
    subTitle: "General Atomics, 2021",
    info: "Oracle SQL, Optimization, Kaizen, Value Stream Mapping",
  },
  {
    id: 4,
    title: "Quantitative Analyst Intern",
    subTitle: "Inclusivest, Sept 2020-Feb 2022",
    info: "Algorithmic Trading, Dynamic Hedging, Volatility Swaps, VC Funding",
  },
  {
    id: 5,
    title: "Co-Founder, Lead Engineer",
    subTitle: "Transparency In Politics, Sept 2020-July 2021",
    info: "Python, Django, VC Funding ",
  },
  {
    id: 3,
    title: "Analytics Administrator",
    subTitle: "Rivo Holdings LLC, July 2020-Sept 2022",
    info: "Tableau, Excel, R",
  },
  {
    id: 1,
    title: "BS/BA Industrial&Systems Engineering",
    subTitle: "University of San Diego, Class of 2020",
    info: "Operations Research, Data Science and Analytics, Simulation, Supply Chain",
  },
];
...
export const SoftwareProjects = [
  {
    ...
    LessonsLearned:
      "Understand the issue you're having as a sole developer from a removed perspectie makes finding solution online (or close proxy to solution) a lot easier. ",
  },
  {
    id: 2,
    title: "OmniaMercado",
  ...
  },
  {
   ...
   " Thought experiment turned actionable project when I decided to show my capabilities as a software engineer instead of just saying I am capable. ",
    ...
    id: 4,
    title: "Transparency In Politics",
